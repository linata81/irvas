...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.style.marginRight = "".concat(scroll, "px"); // document.body.classList.add('modal-open');//класс бутстрапа для подложки      
      });
    });
  ...
  function calcScroll() {
    ...
    var scrollWidth = div.offsetWidth - div.clientWidth; //div.offsetWidth -полная ширина
...
var timer = function timer(id, deadline) {
  ...
  var getTimeRemainind = function getTimeRemainind(endtime) {
    var t = Date.parse(endtime) - Date.parse(new Date()),
        seconds = Math.floor(t / 1000 % 60),
        //миллисекунды/1000 чтобы получить секунды /60 минут, чтобы получить хвостик секунд
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    function updateClock() {
      var t = getTimeRemainind(endtime);
